  ...
  return (
    <>
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-indigo-50 dark:bg-stone-900 border border-indigo-200 dark:border-stone-700 rounded-xl p-8 max-w-md w-full shadow-lg"
          ...
          >
            ...
            <div className="space-y-4 text-stone-700 dark:text-stone-300">
              ...
              <ul className="list-none space-y-3">
                <li className="flex items-start gap-3 px-4 py-2 rounded-lg bg-indigo-100 dark:bg-stone-800 border border-indigo-200 dark:border-stone-700">
